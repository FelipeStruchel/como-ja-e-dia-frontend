...
export const api = {
    ...
    listUsers: (status) => {
        ...
        return fetch(`/api/auth/users${query}`).then(handleResponse);
    },
    approveUser: (id) =>
        fetch(`/api/auth/users/${id}/approve`, { method: "POST" }).then(handleResponse),
    blockUser: (id) =>
        fetch(`/api/auth/users/${id}/block`, { method: "POST" }).then(handleResponse),

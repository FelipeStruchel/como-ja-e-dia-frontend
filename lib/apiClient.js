...
export const api = {
    ...
    getWhatsAppQr: () =>
        fetch("/api/whatsapp-qr", { ...withCreds, headers: handleHeaders() }).then((res) => {
    ...
    getGroupContext: (groupId) =>
        fetch(`/api/context/${encodeURIComponent(groupId)}`, {
            ...withCreds,
            headers: handleHeaders(),
        }).then(handleResponse),
    refreshGroupContext: (groupId) =>
    ...
    // Schedules
    getSchedules: () =>
        fetch("/api/schedules", { ...withCreds, headers: handleHeaders() }).then(handleResponse),
